...
Full spec for this chapter in [spec/ch09/](../spec/ch09/):

📁 [spec/ch09/](../spec/ch09/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch09/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch09/interface-spec.md) | MistakeJournal, EvaluatorOptimizerLoop, refine_skill, incorporate_feedback, verify_improvement contracts |
| [expected-output.txt](../spec/ch09/expected-output.txt) | Mistake logging, skill rewrite, eval-opt convergence, user feedback, verification |
| [test_ch09.py](../spec/ch09/validation/test_ch09.py) | Tests: journal persistence, skill versioning, eval-opt convergence, rule retrieval, before/after verification |
