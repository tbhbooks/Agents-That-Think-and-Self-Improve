...
Full spec for this chapter in [spec/ch08/](../spec/ch08/):

📁 [spec/ch08/](../spec/ch08/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch08/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch08/interface-spec.md) | Evaluator, EvalResult, Guardrail, Escalation contracts |
| [expected-output.txt](../spec/ch08/expected-output.txt) | Evaluation pass, guardrail block, escalation, diagnostics |
| [test_ch08.py](../spec/ch08/validation/test_ch08.py) | Tests: evaluation scoring, guardrail enforcement, fail-closed behavior, escalation context, diagnostics |
