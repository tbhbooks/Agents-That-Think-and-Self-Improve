...
Full spec for this chapter in [spec/ch05/](../spec/ch05/):

📁 [spec/ch05/](../spec/ch05/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch05/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch05/interface-spec.md) | write_file, delete_file, execute_shell, PermissionLevel, ActionGate contracts |
| [expected-output.txt](../spec/ch05/expected-output.txt) | File writes, shell execution, gates, end-to-end fix |
| [test_ch05.py](../spec/ch05/validation/test_ch05.py) | Tests: tool execution, permission model, gate behavior, idempotent writes, end-to-end |
