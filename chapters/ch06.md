...
Full spec for this chapter in [spec/ch06/](../spec/ch06/):

📁 [spec/ch06/](../spec/ch06/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch06/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch06/interface-spec.md) | MemoryStore, Session, ContextBudget, OutcomeEntry contracts |
| [expected-output.txt](../spec/ch06/expected-output.txt) | Session persistence, retrieval, budget math, outcome tracking across sessions |
| [test_ch06.py](../spec/ch06/validation/test_ch06.py) | Tests: memory save/search, session restore, budget limits, outcome structure |
