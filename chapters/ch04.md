...
Full spec for this chapter in [spec/ch04/](../spec/ch04/):

📁 [spec/ch04/](../spec/ch04/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch04/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch04/interface-spec.md) | SkillTool, SkillSpec, SkillStep, SkillLoader, matching |
| [expected-output.txt](../spec/ch04/expected-output.txt) | Skill loading, matching, execution, fallback traces |
| [test_ch04.py](../spec/ch04/validation/test_ch04.py) | Tests: skill loading, matching, execution, fallback |
