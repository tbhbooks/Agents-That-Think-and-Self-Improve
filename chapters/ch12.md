...
Full spec for this chapter in [spec/ch12/](../spec/ch12/):

📁 [spec/ch12/](../spec/ch12/)

| File | Description |
|------|-------------|
| [prompt-template.md](../spec/ch12/prompt-template.md) | What to build (language-agnostic) |
| [interface-spec.md](../spec/ch12/interface-spec.md) | Message, Artifact, PeerMessenger contracts, send/receive/request/stream APIs |
| [expected-output.txt](../spec/ch12/expected-output.txt) | Request/response, streaming, artifact handoff, full chain trace with correlation IDs |
| [test_ch12.py](../spec/ch12/validation/test_ch12.py) | Tests: messages delivered, correlation IDs link chain, artifacts intact, streams complete, full chain runs end to end |
